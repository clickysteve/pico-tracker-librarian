...
```bash
node tests/parser.test.mjs   # 165 unit tests: formats, MIDI timing, slice/loop units, round-trips, generators, scales, audio analysis
...
node tests/e2e.mjs           # 267 browser checks (needs: npm i -D playwright)
```
